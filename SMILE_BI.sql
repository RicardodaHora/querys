...
SET @str_comando2 = 'bcp " SELECT * FROM ##PED_CORTE'
...
SET @str_comando2 = 'bcp " SELECT * FROM ##CLASS_PR'
SET @str_comando2 = @str_comando2 + ' " '
SET @str_comando2 = @str_comando2 + ' queryout ' + @str_NomeArquivo2 + ' -c -t ";" -T';
...
SET @str_comando2 = 'bcp " SELECT * FROM ##MOV_PED'
SET @str_comando2 = @str_comando2 + ' " '
SET @str_comando2 = @str_comando2 + ' queryout ' + @str_NomeArquivo2 + ' -c -t ";" -T';
...
SET @str_comando2 = 'bcp " SELECT * FROM ##ALMOX'
SET @str_comando2 = @str_comando2 + ' " '
SET @str_comando2 = @str_comando2 + ' queryout ' + @str_NomeArquivo2 + ' -c -t ";" -T';
...
SET @str_comando2 = 'bcp " SELECT * FROM ##AREAS'
SET @str_comando2 = @str_comando2 + ' " '
SET @str_comando2 = @str_comando2 + ' queryout ' + @str_NomeArquivo2 + ' -c -t ";" -T';
...
SET @str_comando2 = 'bcp " SELECT * FROM ##BATMIN'
SET @str_comando2 = @str_comando2 + ' " '
SET @str_comando2 = @str_comando2 + ' queryout ' + @str_NomeArquivo2 + ' -c -t ";" -T';
...
SELECT * FROM NEWAGE.DBO.BUDGET_PLANO_VENDAS	WHERE PERIODO IN ( '20172018')

EXECUTE SP_EXECUTESQL @str_comando

SET @str_comando2 = 'bcp " SELECT * FROM ##BUDGET_PLANO_VENDAS'
SET @str_comando2 = @str_comando2 + ' " '
SET @str_comando2 = @str_comando2 + ' queryout ' + @str_NomeArquivo2 + ' -c -t ";" -T';
...
SET @str_comando2 = 'bcp " SELECT * FROM ##CARGAS'
SET @str_comando2 = @str_comando2 + ' " '
SET @str_comando2 = @str_comando2 + ' queryout ' + @str_NomeArquivo2 + ' -c -t ";" -T';
...
SET @str_comando2 = 'bcp " SELECT * FROM ##CATEGOR'
SET @str_comando2 = @str_comando2 + ' " '
SET @str_comando2 = @str_comando2 + ' queryout ' + @str_NomeArquivo2 + ' -c -t ";" -T';
...
SET @str_comando2 = 'bcp " SELECT * FROM ##CLASS_BFC'
SET @str_comando2 = @str_comando2 + ' " '
SET @str_comando2 = @str_comando2 + ' queryout ' + @str_NomeArquivo2 + ' -c -t ";" -T';
...
SET @str_comando2 = 'bcp " SELECT * FROM ##CON_ENSAI'
SET @str_comando2 = @str_comando2 + ' " '
SET @str_comando2 = @str_comando2 + ' queryout ' + @str_NomeArquivo2 + ' -c -t ";" -T';
...
select top 10 * from ##custo_saldo
where quantidade = 0
...
SET @str_comando2 = 'bcp " SELECT * FROM ##DIVISAO_NEGOCIO'
SET @str_comando2 = @str_comando2 + ' " '
SET @str_comando2 = @str_comando2 + ' queryout ' + @str_NomeArquivo2 + ' -c -t ";" -T';
...
--SET @str_comando2 = 'bcp " SELECT * FROM ##EMPRESAS'
--SET @str_comando2 = @str_comando2 + ' " '
--SET @str_comando2 = @str_comando2 + ' queryout ' + @str_NomeArquivo2 + ' -c -t ";" -T';
--select @str_comando2
--Exec xp_cmdshell @str_comando2 
...
SET @str_comando2 = 'bcp " SELECT * FROM ##ADDRESS'
SET @str_comando2 = @str_comando2 + ' " '
SET @str_comando2 = @str_comando2 + ' queryout ' + @str_NomeArquivo2 + ' -c -t ";" -T';
...
SET @str_comando2 = 'bcp " SELECT * FROM ##FAMILIA'
SET @str_comando2 = @str_comando2 + ' " '
SET @str_comando2 = @str_comando2 + ' queryout ' + @str_NomeArquivo2 + ' -c -t ";" -T';
...
SET @str_comando2 = 'bcp " SELECT * FROM ##GERAL'
SET @str_comando2 = @str_comando2 + ' " '
SET @str_comando2 = @str_comando2 + ' queryout ' + @str_NomeArquivo2 + ' -c -t ";" -T';
...
SET @str_comando2 = 'bcp " SELECT * FROM ##GERAL6'
SET @str_comando2 = @str_comando2 + ' " '
SET @str_comando2 = @str_comando2 + ' queryout ' + @str_NomeArquivo2 + ' -c -t ";" -T';
...
SET @str_comando2 = 'bcp " SELECT * FROM ##GERAL_WMS'
SET @str_comando2 = @str_comando2 + ' " '
SET @str_comando2 = @str_comando2 + ' queryout ' + @str_NomeArquivo2 + ' -c -t ";" -T';
...
SET @str_comando2 = 'bcp " SELECT * FROM ##LINHA_PRODUTO'
SET @str_comando2 = @str_comando2 + ' " '
SET @str_comando2 = @str_comando2 + ' queryout ' + @str_NomeArquivo2 + ' -c -t ";" -T';
...
SET @str_comando2 = 'bcp " SELECT * FROM ##MACRO'
SET @str_comando2 = @str_comando2 + ' " '
SET @str_comando2 = @str_comando2 + ' queryout ' + @str_NomeArquivo2 + ' -c -t ";" -T';
...
INTO ##MOV_CON 
--FROM NEWAGE.DBO.MOV_CON WHERE EXTORNADO IS NULL AND DATA>='01/01/2018' AND DATA<='06/30/2018' 
...
SET @str_comando2 = 'bcp " SELECT * FROM ##MOV_CUSTO'
SET @str_comando2 = @str_comando2 + ' " '
SET @str_comando2 = @str_comando2 + ' queryout ' + @str_NomeArquivo2 + ' -c -t ";" -T';
...
SET @str_comando2 = 'bcp " SELECT * FROM ##MOV_ENTREGA'
SET @str_comando2 = @str_comando2 + ' " '
SET @str_comando2 = @str_comando2 + ' queryout ' + @str_NomeArquivo2 + ' -c -t ";" -T';
...
SET @str_comando2 = 'bcp " SELECT * FROM ##MOV_MARGEM'
SET @str_comando2 = @str_comando2 + ' " '
SET @str_comando2 = @str_comando2 + ' queryout ' + @str_NomeArquivo2 + ' -c -t ";" -T';
...
SET @str_comando2 = 'bcp " SELECT * FROM ##NEGOCIO'
SET @str_comando2 = @str_comando2 + ' " '
SET @str_comando2 = @str_comando2 + ' queryout ' + @str_NomeArquivo2 + ' -c -t ";" -T';
...
SET @str_comando2 = 'bcp " SELECT * FROM ##PAGREC'
SET @str_comando2 = @str_comando2 + ' " '
SET @str_comando2 = @str_comando2 + ' queryout ' + @str_NomeArquivo2 + ' -c -t ";" -T';
...
SET @str_comando2 = 'bcp " SELECT * FROM ##PAIS'
SET @str_comando2 = @str_comando2 + ' " '
SET @str_comando2 = @str_comando2 + ' queryout ' + @str_NomeArquivo2 + ' -c -t ";" -T';
...
SET @str_comando2 = 'bcp " SELECT * FROM ##ORDERS'
SET @str_comando2 = @str_comando2 + ' " '
SET @str_comando2 = @str_comando2 + ' queryout ' + @str_NomeArquivo2 + ' -c -t ";" -T';
...
SET @str_comando2 = 'bcp " SELECT * FROM ##PRODUCAO_ORDEM'
SET @str_comando2 = @str_comando2 + ' " '
SET @str_comando2 = @str_comando2 + ' queryout ' + @str_NomeArquivo2 + ' -c -t ";" -T';
...
SET @str_comando2 = 'bcp " SELECT * FROM ##RCBT02'
SET @str_comando2 = @str_comando2 + ' " '
SET @str_comando2 = @str_comando2 + ' queryout ' + @str_NomeArquivo2 + ' -c -t ";" -T';
...
SET @str_comando2 = 'bcp " SELECT * FROM ##TEXTURAS'
SET @str_comando2 = @str_comando2 + ' " '
SET @str_comando2 = @str_comando2 + ' queryout ' + @str_NomeArquivo2 + ' -c -t ";" -T';
...
SET @str_comando2 = 'bcp " SELECT * FROM ##TIPO_MOVIMENTO_CUSTOS'
SET @str_comando2 = @str_comando2 + ' " '
SET @str_comando2 = @str_comando2 + ' queryout ' + @str_NomeArquivo2 + ' -c -t ";" -T';
...
SET @str_comando2 = 'bcp " SELECT * FROM ##TRANSC'
SET @str_comando2 = @str_comando2 + ' " '
SET @str_comando2 = @str_comando2 + ' queryout ' + @str_NomeArquivo2 + ' -c -t ";" -T';
...
SET @str_comando2 = 'bcp " SELECT * FROM ##UNIDADES'
SET @str_comando2 = @str_comando2 + ' " '
SET @str_comando2 = @str_comando2 + ' queryout ' + @str_NomeArquivo2 + ' -c -t ";" -T';
...
SET @str_comando2 = 'bcp " SELECT * FROM ##USUARIOS'
SET @str_comando2 = @str_comando2 + ' " '
SET @str_comando2 = @str_comando2 + ' queryout ' + @str_NomeArquivo2 + ' -c -t ";" -T';
...
SELECT TOP 5 * FROM VW_PARTIDAS_RM

SP_HELPTEXT VW_PARTIDAS_RM
...
SET @str_comando2 = 'bcp " SELECT * FROM ##VW_PARTIDAS_RM'
SET @str_comando2 = @str_comando2 + ' " '
SET @str_comando2 = @str_comando2 + ' queryout ' + @str_NomeArquivo2 + ' -c -t ";" -T';
...
SET @str_comando2 = 'bcp " SELECT * FROM ##PLANO'
SET @str_comando2 = @str_comando2 + ' " '
SET @str_comando2 = @str_comando2 + ' queryout ' + @str_NomeArquivo2 + ' -c -t ";" -T';
...
SET @str_comando2 = 'bcp " SELECT * FROM ##SCCUSTO'
SET @str_comando2 = @str_comando2 + ' " '
SET @str_comando2 = @str_comando2 + ' queryout ' + @str_NomeArquivo2 + ' -c -t ";" -T';
...
SET @str_comando2 = 'bcp " SELECT * FROM ##VW_VALE_FRETE'
SET @str_comando2 = @str_comando2 + ' " '
SET @str_comando2 = @str_comando2 + ' queryout ' + @str_NomeArquivo2 + ' -c -t ";" -T';
...
************************************************************************************************************
SELECT * FROM TIPO_CAMINHAO_CARGA
...
SET @str_comando2 = 'bcp " SELECT * FROM ##TIPO_CAMINHAO_CARGA'
SET @str_comando2 = @str_comando2 + ' " '
SET @str_comando2 = @str_comando2 + ' queryout ' + @str_NomeArquivo2 + ' -c -t ";" -T';
...
SET @str_comando2 = 'bcp " SELECT * FROM ##CONDICOE'
SET @str_comando2 = @str_comando2 + ' " '
SET @str_comando2 = @str_comando2 + ' queryout ' + @str_NomeArquivo2 + ' -c -t ";" -T';
...
SELECT TOP 5 * FROM CUSTO_SALDO 
WHERE EMPRESA = 20 AND CODIGO ='14.1007.90.99' AND DATA='12/18/2017'


SELECT TOP 50 A.PED,A.DT_PROGAM,B.DATA_ENT,B.DATA_SAI
FROM PEDIDO A INNER JOIN CON_ENSAI B ON A.NUM_CARGA = B.CARGA
WHERE A.ABERTA>='07/01/2017' AND A.ABERTA<='12/01/2017'
AND A.PED = 'P2089923    '



SELECT A.PED,A.DT_PROGAM,B.DATA_ENT,B.DATA_SAI,A.CAMINHAO
FROM PEDIDO A INNER JOIN CON_ENSAI B ON A.NUM_CARGA = B.CARGA
WHERE A.PED = 'P2089923    '

SELECT * FROM TIPO_CAMINHAO

SELECT A.PED,A.END_ENTR,B.*
FROM PEDIDO A LEFT OUTER JOIN ENDERECO B ON A.END_ENTR = B.REGISTRO AND A.CLIENTE = B.CLI_FOR
WHERE A.PED = 'P2089923    '

SELECT * FROM TIPO_CAMINHAO_CARGA
WHERE CODIGO = 4

SELECT TOP 500 * FROM VW_PARTIDAS_RM
WHERE DATA>='07/01/2017'
ORDER BY DATA
...
SET @WORKDIR ='\\Srv-sql-hml\d$\Temp\SMILE_BI\'
SET @COMANDO = 'DIR '+RTRIM(LTRIM(@WORKDIR))+'*.CSV /B'
--SET @COMANDO = 'DIR '+RTRIM(LTRIM(@WORKDIR))+'RETBB.TXT /B'
